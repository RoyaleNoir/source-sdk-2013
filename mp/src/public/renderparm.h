...
enum RenderParamVector_t
{
	...
	VECTOR_RENDERPARM_DEFERRED_LIGHTPOS,
	VECTOR_RENDERPARM_DEFERRED_LIGHTCOLOR,
	VECTOR_RENDERPARM_DEFERRED_LIGHTDIR,
...
{
	FLOAT_RENDERPARM_DEFERRED_LIGHTOUTERCONE = 0,
	FLOAT_RENDERPARM_DEFERRED_LIGHTINNERCONE,
	FLOAT_RENDERPARM_DEFERRED_LIGHTCUTOFF,
...
enum RenderParamInt_t
{
	...
	// TODO: Find another way to send these
	INT_RENDERPARM_DEFERRED_INVVIEWMATRIX_ADDR,
	INT_RENDERPARM_DEFERRED_INVPROJMATRIX_ADDR,
	INT_RENDERPARM_DEFERRED_LIGHTTYPE,
